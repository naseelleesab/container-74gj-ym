...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-74gj-ym.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-74gj-ym.containers.anotherwebservice.com/
...
```
git clone git@github.com:naseelleesab/container-74gj-ym.git
cd container-74gj-ym
```
...
```
docker attach container-74gj-ym
```
